...
const features = [
  {
    ...
    description: "Blazing fast file uploads with parallel processing and optimized transfer protocols",
    command: "ksau upload --parallel ./files",
    stat: "10x faster",
  ...
  },
  {
    ...
    description: "Enterprise-grade encryption ensures your files stay private and protected",
    command: "ksau upload --encrypt secret.pdf",
    stat: "AES-256",
  ...
  },
  {
    Icon: RefreshCcw,
    name: "Auto-Sync",
    description: "Keep your files synchronized across all storage providers automatically",
    command: "ksau sync --watch ~/documents",
    stat: "Real-time",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    ...
    description: "Track changes and restore previous versions of your files effortlessly",
    command: "ksau versions list file.txt",
    stat: "Unlimited",
    className: "md:col-span-1 md:row-span-2",
  },
  {
    ...
    description: "Generate secure, expirable links to share files with anyone instantly",
    command: "ksau share file.zip --expiry 7d",
    stat: "1-click",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    Icon: Search,
    name: "Smart Search",
    description: "Find files instantly with powerful pattern matching and filtering",
    command: "ksau search '*.pdf' --modified 7d",
    stat: "<100ms",
